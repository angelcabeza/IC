...
(influye  vacuna Paludismo)    ; inminidad influye en la probabilidad de Padulismo
(efecto tos Paludismo)    ; gota_gruesa es un efecto o síntoma común de Padulismo
...
(prob vacuna mayor 0.6)
(prob vacuna menor 0.4)
)

(deffacts distribucion_segun_valores_variables_que_influyen
(probcond2 Paludismo SI zona_origen alto_riesgo vacuna mayor 0.015)
(probcond2 Paludismo SI zona_origen alto_riesgo vacuna menor 0.022)
(probcond2 Paludismo SI zona_origen medio_riesgo vacuna mayor 0.003)
(probcond2 Paludismo SI zona_origen medio_riesgo vacuna menor 0.012)
(probcond2 Paludismo SI zona_origen bajo_riesgo vacuna mayor 0.0003)
(probcond2 Paludismo SI zona_origen bajo_riesgo vacuna menor 0.0008)
)

(deffacts probabilidad_efectos
(probcond tos si Paludismo SI 0.992)
(probcond tos si Paludismo NO 0.006)
...
(probconj2 Paludismo SI vacuna mayor 0)
(probconj2 Paludismo SI vacuna menor 0)
(prob Paludismo SI 0)
)
...
(red causal causas)
=>
(printout t "Escribe una opcion: Vacuna (1=si 2=no 3=Desconocido): " )
(bind ?respuesta (read))
(if (= ?respuesta 1) then (assert (valor vacuna mayor))
  else (if (= ?respuesta 2) then (assert (valor vacuna menor))
