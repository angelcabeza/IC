...
;; HE MODIFICADO ESTOS VALORES PARA EL APARTADO A
(deffacts conjuntos_difusos
(cd temperatura normal 35 36 37 37.2)   ; entre 35 y 37
(cd temperatura destemplada 37.5 37.5 37.8 38.5)  ; aproximadamente entre 37.5 y 38.5
(cd temperatura alta 37.8 38.5 100 100)  ; aproximadamente mas 38.5
(cd peso bajo 0 0 40 50)     ; aproximadamente  menos de 40
(cd peso medio 55 55 70 75)  ; aproximadamente entre 55 y 70
(cd peso alto 70 95 300 300) ; aproximadamente mas de 95
(cd dosis cero 0 0 0 0)
(cd dosis baja 3 4 4 5.5)    ; aproximadamente 4
(cd dosis media 5 6 6 7)     ; aproximadamente 6
(cd dosis alta 9 10 10 11)     ; aprximadamente 10
(cd edad baja 0 0 17 20)    ; aproximadamente menos de 17
(cd edad media 20 30 40 50) ; aproximadamente entre 20 y 50
(cd edad alta 40 50 300 300) ;aproximadamente más de 50
...
(regla 2 antecedente edad media)
(regla 2 consecuente dosis media)
(regla 2 explicacion "Si esta destemplado, el peso es medio, y la edad media la dosis a aplicar es media")
(regla 2bis antecedente temperatura destemplada)
(regla 2bis antecedente peso alto)
(regla 2bis consecuente dosis media)
(regla 2bis antecedente edad alta)
(regla 2bis explicacion "Si esta destemplado, el peso es alto y la edad es alta , la dosis a aplicar es media")
(regla 3 antecedente temperatura destemplada)
(regla 3 antecedente peso bajo)
(regla 3 consecuente dosis baja)
(regla 3 antecedente edad baja)
(regla 3 explicacion "Si esta destemplado, el peso es bajo y la edad es baja, la dosis a aplicar es baja")
(regla 4 antecedente temperatura alta)
(regla 4 consecuente dosis alta)
(regla 4 antecedente edad baja)
(regla 4 explicacion "Si la temperatura es alta y la edad es baja, la dosis a aplicar es alta")
)
...
;; ESTA REGLA ES LA QUE HE AGREGADO PARA CAÑADIR UNA VARIABLE DE ENTRADA NUEVA
(defrule pregunta4 
(declare (salience 1)) 
=>
(printout t "Edad: ")
